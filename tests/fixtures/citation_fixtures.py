...
CITATION_TITLE_ONLY = Citation(title='Transformers for Natural Language Processing')
...
MOCK_CROSSREF_RESPONSE: Dict[str, Any] = {  # noqa: UP006
    'status': 'ok',
...
MOCK_OPENALEX_RESPONSE: Dict[str, Any] = {  # noqa: UP006
    'results': [
        {
...
MOCK_SEMANTIC_SCHOLAR_PAPER: Dict[str, Any] = {  # noqa: UP006
    'paperId': 'abc123def456',
    'title': 'Deep Learning for Image Recognition',
    'abstract': 'This paper presents a deep learning approach for image recognition...',
    'year': 2023,
    'venue': 'Nature',
    'authors': [{'name': 'John Smith'}, {'name': 'Alice Doe'}],
    'externalIds': {'DOI': '10.1038/nature12345', 'ArXiv': '2301.12345'},
    'citationCount': 156,
...
EXPECTED_HIGH_CONFIDENCE_RESULT = ResolutionResult(
    ...
    metadata=ResolutionMetadata(
        api_sources_tried=[APISource.CROSSREF], processing_time_ms=150.5
    ),
)
...
SERVER_ERROR_RESPONSE = {'status_code': 503, 'message': 'Service Unavailable'}
...
BATCH_CITATIONS: List[Citation] = [  # noqa: UP006
    CITATION_WITH_DOI,
    CITATION_WITH_ARXIV,
...
CITATION_EMPTY_TITLE = Citation(title='', authors=['Smith, J.'], year=2023)
...
CITATION_UNICODE = Citation(
    title='深度学习在图像识别中的应用', authors=['李明', '王芳'], year=2023
)
...
def create_mock_crossref_match(
    doi: str = '10.1234/test', title: str = 'Test Paper', score: float = 85.0
...
def create_mock_openalex_match(
    doi: str = '10.1234/test', title: str = 'Test Paper', openalex_id: str = 'W123456'
) -> Dict[str, Any]:  # noqa: UP006
...
def create_mock_semantic_scholar_paper(
    doi: str = '10.1234/test', title: str = 'Test Paper', paper_id: str = 'abc123'
) -> Dict[str, Any]:  # noqa: UP006
