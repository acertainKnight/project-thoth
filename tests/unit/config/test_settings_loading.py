...
from tests.fixtures.config_fixtures import (
    get_full_settings_json,  # noqa: F401
    get_invalid_settings_json,  # noqa: F401
    get_minimal_settings_json,  # noqa: F401
)
...
class TestSettingsFromJsonFile:
    ...
    def test_load_malformed_json(self, malformed_json_file: Path):
        ...
        with pytest.raises(Exception):  # json.JSONDecodeError  # noqa: B017
...
class TestSchemaFields:
    ...
    def test_schema_field_parsing(self, temp_vault: Path):
        ...
        settings_data = {'$schema': './custom.schema.json', 'version': '2.0.0'}
    ...
    def test_comment_field_parsing(self, temp_vault: Path):
        ...
        settings_data = {'_comment': 'This is a test comment'}
    ...
    def test_last_modified_field(self, temp_vault: Path):
        ...
        settings_data = {'lastModified': '2025-12-31T12:00:00Z'}
            ...
            'memory': {
                'scheduler': {
                    'jobs': {
                        ...
                        'weekly': {'enabled': False, 'intervalHours': 168},
                    }
                }
            }
        }
...
class TestErrorHandling:
    ...
    def test_unicode_in_json(self, temp_vault: Path):
        ...
        settings_data = {'_comment': 'Test with unicode: 中文 🚀 café'}
...
class TestExtraFieldsAllowed:
    ...
    def test_extra_nested_fields_ignored(self, temp_vault: Path):
        ...
        settings_data = {
            'llm': {'default': {'model': 'test', 'unknownField': 'should-be-ignored'}}
        }
...
class TestRealWorldScenarios:
    ...
    def test_load_production_like_config(self, temp_vault: Path):
        ...
        from tests.fixtures.config_fixtures import get_full_settings_json  # noqa: F811
