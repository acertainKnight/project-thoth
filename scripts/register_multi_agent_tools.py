...
async def register_tools():
    ...
    functions = [
        ...
        ("send_message_to_agent_and_wait_for_reply", multi_agent.send_message_to_agent_and_wait_for_reply),
    ]
    ...
    for agent_id in agent_ids:
        try:
            ...
            if async_tool_id and async_tool_id not in current_tool_ids:
                ...
                print(f"    ✅ Added send_message_to_agent_async")
            else:
                print(f"    ℹ️  Tool already attached or not available")
