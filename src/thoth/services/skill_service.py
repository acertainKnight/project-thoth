...
class SkillService(BaseService):
    ...
    ROLE_SKILLS = {
        ...
        'coordinator': ['paper-discovery', 'knowledge-base-qa', 'research-project-coordination'],
    ...
    def filter_by_role(self, skills: dict[str, dict[str, Any]], role: str) -> dict[str, dict[str, Any]]:
        """
