...
async def run_browser_workflow_migration():
    ...
    try:
        ...
        try:
            ...
            migration_file = (
                Path(__file__).parent / '002_add_browser_discovery_workflows.sql'
            )

            if not migration_file.exists():
                console.print(
                    f'[red]✗ Migration file not found: {migration_file}[/red]'
                )
                return False
            ...
            async with conn.transaction():
                ...
                try:
                    ...
                    console.print(
                        f'[yellow]⚠ Some objects already exist (this is OK): {e}[/yellow]'
                    )
        ...
        console.print(f'[red]✗ Database does not exist. Please create it first:[/red]')  # noqa: F541
        console.print(f'   createdb thoth')  # noqa: F541
        return False
