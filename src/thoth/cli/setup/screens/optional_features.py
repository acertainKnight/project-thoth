...
class OptionalFeaturesScreen(BaseScreen):
    ...
    def compose_content(self) -> ComposeResult:
        ...
        with Vertical(classes="feature-section"):
            ...
            yield Checkbox("Enable RAG & Semantic Search", id="rag-checkbox", value=True)
        ...
        with Vertical(classes="feature-section"):
            ...
            yield Checkbox("Enable Paper Discovery", id="discovery-checkbox", value=True)
        ...
        with Vertical(classes="feature-section"):
            ...
            yield Checkbox("Enable Citation Resolution", id="citations-checkbox", value=True)
    ...
    async def validate_and_proceed(self) -> dict[str, Any] | None:
        ...
        try:
            ...
            local_embeddings_checkbox = self.query_one("#local-embeddings-checkbox", Checkbox)
