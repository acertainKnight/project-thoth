...
from typing import List, Dict  # noqa: I001, UP035
...
def plot_precision_recall_curve(
    metrics_by_threshold: Dict[float, CitationMetrics],  # noqa: UP006
    output_path: Path,
...
def plot_calibration_curve(
    ground_truth: List,  # noqa: UP006
    results: List,  # noqa: UP006
    output_path: Path,
    num_bins: int = 10,
    ...
    # Shade regions
    plt.fill_between(
        [0, 1], [0, 1], [1, 1], alpha=0.1, color='red', label='Overconfident'
    )
    plt.fill_between(
        [0, 1], [0, 0], [0, 1], alpha=0.1, color='blue', label='Underconfident'
    )
...
def plot_confusion_matrix(
    confusion: ConfusionMatrix, output_path: Path, title: str = 'Confusion Matrix'
):
    """
...
def create_evaluation_report(
    ...
    print(f'   - evaluation_report.txt')  # noqa: F541
