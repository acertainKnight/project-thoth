...
class AnalysisGroundTruthPair:
    ...
    expected_strategy: Optional[str] = None  # direct, map_reduce, refine
...
class AnalysisGroundTruthGenerator:
    ...
    async def _generate_low_complexity(self, count: int) -> List[AnalysisGroundTruthPair]:
    ...
    async def _generate_medium_complexity(self, count: int) -> List[AnalysisGroundTruthPair]:
    ...
    async def _generate_high_complexity(self, count: int) -> List[AnalysisGroundTruthPair]:
        ...
        try:
            ...
            for paper in papers:
                ...
                # Create very long content by expanding abstract into full paper structure
                paper_content = f"# {paper['title']}\n\n"
    ...
    async def save_ground_truth(
        self,
        pairs: List[AnalysisGroundTruthPair],
        output_path: Path
    ) -> None:
    ...
    async def load_ground_truth(self, input_path: Path) -> List[AnalysisGroundTruthPair]:
